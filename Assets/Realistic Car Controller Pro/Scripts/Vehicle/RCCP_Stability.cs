...
public class RCCP_Stability : RCCP_Component {
    ...
    private void SteerHelper() {
        ...
        CarController.Rigid.velocity = Vector3.Lerp(
            CarController.Rigid.velocity,
    ...
    private void AngularDragHelper() {
        ...
        CarController.Rigid.angularDrag = Mathf.Lerp(CarController.Rigid.angularDrag, targetAngularDrag, Time.fixedDeltaTime * 2f);
