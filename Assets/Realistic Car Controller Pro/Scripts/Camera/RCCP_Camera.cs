...
public class RCCP_Camera : RCCP_GenericComponent {
    ...
    private void TPS() {
        ...
        float xVel = cameraTarget.playerVehicle.transform.InverseTransformDirection(cameraTarget.playerVehicle.Rigid.velocity).x;
    ...
    private void TPS2() {
        ...
        float localVelocityX = cameraTarget.playerVehicle.transform
            .InverseTransformDirection(cameraTarget.playerVehicle.Rigid.velocity).x;
